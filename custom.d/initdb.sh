...
echo "*** MySQL - Creating tree database lxr_mydb"
mysql -u lxr -plxrpw <<END_OF_CREATE
drop database if exists lxr_mydb;
create database lxr_mydb;
END_OF_CREATE

echo "*** MySQL - Configuring tables lxr_ in database lxr_mydb"
